...
const Footer = () => {
  ...
  return (
    <nav className="footer-section">
      ...
      <div className="icons">
        <a href="https://www.instagram.com/c_owo_qwq_?igsh=MWxvMXprNDZveTFxdQ=="><FaInstagram size={40} color='gray'/></a>
        <a href="https://www.linkedin.com/in/kris-0-965047369"><FaLinkedinIn size={40} color='gray'/></a>
